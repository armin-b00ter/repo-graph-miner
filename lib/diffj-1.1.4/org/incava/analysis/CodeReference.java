...
public class CodeReference implements Comparable
{
    ...
    public CodeReference(String type,
                         ...
                         int secondBeginLine, int secondBeginColumn, int secondEndLine, int secondEndColumn)
    {
        this(type,
             message,
     ...
     */
    public CodeReference(String type, String message, Point firstStart, Point firstEnd, Point secondStart, Point secondEnd)
    {
        this.type        = type;
     ...
     */
    public CodeReference(String type, String message, Token a, Token b)
    {
