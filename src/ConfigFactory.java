...
import config.JHotDrawConfigurerSample;
import config.TomCatConfigurerSample;
...
public class ConfigFactory {
    ...
    public ConfigFactory() {
        configInstances.put("jhotdraw", new JHotDrawConfigurerSample());
        configInstances.put("tomcat", new TomCatConfigurerSample());
